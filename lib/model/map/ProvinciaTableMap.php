...
class ProvinciaTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('ID_PROVINCIA', 'IdProvincia', 'INTEGER', true, null, null);
    ...
    {
        $this->addRelation('Localidad', 'Localidad', RelationMap::ONE_TO_MANY, array('id_provincia' => 'provincia_id_provincia', ), null, null, 'Localidads');
    } // buildRelations()
