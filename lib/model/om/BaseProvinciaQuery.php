 ...
 * @method     ProvinciaQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 *
 * @method     ProvinciaQuery groupByIdProvincia() Group by the id_provincia column
 * @method     ProvinciaQuery groupByNombre() Group by the nombre column
 *
 ...
 * @method     Provincia findOneByNombre(string $nombre) Return the first Provincia filtered by the nombre column
 *
 * @method     array findByIdProvincia(int $id_provincia) Return Provincia objects filtered by the id_provincia column
 * @method     array findByNombre(string $nombre) Return Provincia objects filtered by the nombre column
 *
...
abstract class BaseProvinciaQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID_PROVINCIA`, `NOMBRE` FROM `provincia` WHERE `ID_PROVINCIA` = :p0';
        try {
    ...
    public function filterByNombre($nombre = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProvinciaPeer::NOMBRE, $nombre, $comparison);
    }
    ...
    public function filterByLocalidad($localidad, $comparison = null)
    {
        if ($localidad instanceof Localidad) {
            return $this
                ->addUsingAlias(ProvinciaPeer::ID_PROVINCIA, $localidad->getProvinciaIdProvincia(), $comparison);
