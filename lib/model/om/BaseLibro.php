 ...
 */
abstract class BaseLibro extends BaseObject 
{
    ...
    public function setArchivo($v)
    {
        ...
        $this->modifiedColumns[] = LibroPeer::ARCHIVO;
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            if ($row[$startcol + 2] !== null) {
                $this->archivo = fopen('php://memory', 'r+');
                fwrite($this->archivo, $row[$startcol + 2]);
                rewind($this->archivo);
            } else {
                $this->archivo = null;
            }
            ...
            return $startcol + 3; // 3 = LibroPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LibroPeer::ARCHIVO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`NOMBRE`':						
                        ...
                        break;
                    case '`ARCHIVO`':						
						if (is_resource($this->archivo)) {
						    rewind($this->archivo);
						}
						$stmt->bindValue($identifier, $this->archivo, PDO::PARAM_LOB);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setArchivo($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LibroPeer::ARCHIVO)) $criteria->add(LibroPeer::ARCHIVO, $this->archivo);
