 ...
 *
 * @method     Usuario findOneByIdusuario(int $idusuario) Return the first Usuario filtered by the idusuario column
...
abstract class BaseUsuarioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `IDUSUARIO`, `NOMBRE`, `PASSWORD` FROM `usuario` WHERE `IDUSUARIO` = :p0';
        try {
