...
/**
 * Base class that represents a row from the 'domicilio_j' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseDomicilioJ extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'DomicilioJPeer';
    ...
    /**
     * The value for the id_domicilio_j field.
     * @var        int
     */
    protected $id_domicilio_j;
    ...
    /**
     * Get the [id_domicilio_j] column value.
     * 
     * @return   int
     */
    public function getIdDomicilioJ()
    {

        return $this->id_domicilio_j;
    }
    ...
    /**
     * Set the value of [id_domicilio_j] column.
     * 
     * @param      int $v new value
     * @return   DomicilioJ The current object (for fluent API support)
     */
    public function setIdDomicilioJ($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_domicilio_j !== $v) {
            $this->id_domicilio_j = $v;
            $this->modifiedColumns[] = DomicilioJPeer::ID_DOMICILIO_J;
        }
    ...
    public function setBarrio($v)
    {
        ...
        if ($this->barrio !== $v) {
            $this->barrio = $v;
            $this->modifiedColumns[] = DomicilioJPeer::BARRIO;
        }
    ...
    public function setCalle($v)
    {
        ...
        if ($this->calle !== $v) {
            $this->calle = $v;
            $this->modifiedColumns[] = DomicilioJPeer::CALLE;
        }
    ...
    public function setAltura($v)
    {
        ...
        if ($this->altura !== $v) {
            $this->altura = $v;
            $this->modifiedColumns[] = DomicilioJPeer::ALTURA;
        }
    ...
    public function setCodPostal($v)
    {
        ...
        if ($this->cod_postal !== $v) {
            $this->cod_postal = $v;
            $this->modifiedColumns[] = DomicilioJPeer::COD_POSTAL;
        }
    ...
    public function setReal($v)
    {
        ...
        if ($this->real !== $v) {
            $this->real = $v;
            $this->modifiedColumns[] = DomicilioJPeer::REAL;
        }
    ...
    public function setLocalidadIdLocalidad($v)
    {
        ...
        if ($this->localidad_id_localidad !== $v) {
            ...
            $this->modifiedColumns[] = DomicilioJPeer::LOCALIDAD_ID_LOCALIDAD;
        }
    ...
    public function setPjuridicaIdPjuridica($v)
    {
        ...
        if ($this->pjuridica_id_pjuridica !== $v) {
            ...
            $this->modifiedColumns[] = DomicilioJPeer::PJURIDICA_ID_PJURIDICA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_domicilio_j = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->pjuridica_id_pjuridica = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = DomicilioJPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DomicilioJ object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DomicilioJPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DomicilioJQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseDomicilioJ:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDomicilioJ:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseDomicilioJ:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDomicilioJ:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                DomicilioJPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = DomicilioJPeer::ID_DOMICILIO_J;
        if (null !== $this->id_domicilio_j) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DomicilioJPeer::ID_DOMICILIO_J . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(DomicilioJPeer::ID_DOMICILIO_J)) {
            $modifiedColumns[':p' . $index++]  = '`ID_DOMICILIO_J`';
        }
        if ($this->isColumnModified(DomicilioJPeer::BARRIO)) {
            $modifiedColumns[':p' . $index++]  = '`BARRIO`';
        }
        if ($this->isColumnModified(DomicilioJPeer::CALLE)) {
            $modifiedColumns[':p' . $index++]  = '`CALLE`';
        }
        if ($this->isColumnModified(DomicilioJPeer::ALTURA)) {
            $modifiedColumns[':p' . $index++]  = '`ALTURA`';
        }
        if ($this->isColumnModified(DomicilioJPeer::COD_POSTAL)) {
            $modifiedColumns[':p' . $index++]  = '`COD_POSTAL`';
        }
        if ($this->isColumnModified(DomicilioJPeer::REAL)) {
            $modifiedColumns[':p' . $index++]  = '`REAL`';
        }
        if ($this->isColumnModified(DomicilioJPeer::LOCALIDAD_ID_LOCALIDAD)) {
            $modifiedColumns[':p' . $index++]  = '`LOCALIDAD_ID_LOCALIDAD`';
        }
        if ($this->isColumnModified(DomicilioJPeer::PJURIDICA_ID_PJURIDICA)) {
            $modifiedColumns[':p' . $index++]  = '`PJURIDICA_ID_PJURIDICA`';
        }

        $sql = sprintf(
            'INSERT INTO `domicilio_j` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID_DOMICILIO_J`':						
						$stmt->bindValue($identifier, $this->id_domicilio_j, PDO::PARAM_INT);
                        break;
                    case '`BARRIO`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DomicilioJPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DomicilioJPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DomicilioJ'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DomicilioJ'][$this->getPrimaryKey()] = true;
        $keys = DomicilioJPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdDomicilioJ(),
            ...
            $keys[7] => $this->getPjuridicaIdPjuridica(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdDomicilioJ($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[7], $arr)) $this->setPjuridicaIdPjuridica($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DomicilioJPeer::ID_DOMICILIO_J)) $criteria->add(DomicilioJPeer::ID_DOMICILIO_J, $this->id_domicilio_j);
        if ($this->isColumnModified(DomicilioJPeer::BARRIO)) $criteria->add(DomicilioJPeer::BARRIO, $this->barrio);
        if ($this->isColumnModified(DomicilioJPeer::CALLE)) $criteria->add(DomicilioJPeer::CALLE, $this->calle);
        if ($this->isColumnModified(DomicilioJPeer::ALTURA)) $criteria->add(DomicilioJPeer::ALTURA, $this->altura);
        if ($this->isColumnModified(DomicilioJPeer::COD_POSTAL)) $criteria->add(DomicilioJPeer::COD_POSTAL, $this->cod_postal);
        if ($this->isColumnModified(DomicilioJPeer::REAL)) $criteria->add(DomicilioJPeer::REAL, $this->real);
        if ($this->isColumnModified(DomicilioJPeer::LOCALIDAD_ID_LOCALIDAD)) $criteria->add(DomicilioJPeer::LOCALIDAD_ID_LOCALIDAD, $this->localidad_id_localidad);
        if ($this->isColumnModified(DomicilioJPeer::PJURIDICA_ID_PJURIDICA)) $criteria->add(DomicilioJPeer::PJURIDICA_ID_PJURIDICA, $this->pjuridica_id_pjuridica);
    ...
    {
        $criteria = new Criteria(DomicilioJPeer::DATABASE_NAME);
        $criteria->add(DomicilioJPeer::ID_DOMICILIO_J, $this->id_domicilio_j);
    ...
    /**
     * Generic method to set the primary key (id_domicilio_j column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdDomicilioJ();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of DomicilioJ (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdDomicilioJ(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 DomicilioJ Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   DomicilioJPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DomicilioJPeer();
        }
    ...
    public function getLocalidad(PropelPDO $con = null)
    {
        if ($this->aLocalidad === null && ($this->localidad_id_localidad !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLocalidad->addDomicilioJs($this);
             */
        }
    ...
    public function getPjuridica(PropelPDO $con = null)
    {
        if ($this->aPjuridica === null && ($this->pjuridica_id_pjuridica !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPjuridica->addDomicilioJs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DomicilioJPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseDomicilioJ:' . $name))
		{
