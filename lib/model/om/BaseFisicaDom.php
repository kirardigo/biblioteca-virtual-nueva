...
/**
 * Base class that represents a row from the 'fisica_dom' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseFisicaDom extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'FisicaDomPeer';
    ...
    /**
     * The value for the id_fisica_dom field.
     * @var        int
     */
    protected $id_fisica_dom;
    ...
    /**
     * Get the [id_fisica_dom] column value.
     * 
     * @return   int
     */
    public function getIdFisicaDom()
    {

        return $this->id_fisica_dom;
    }
    ...
    /**
     * Set the value of [id_fisica_dom] column.
     * 
     * @param      int $v new value
     * @return   FisicaDom The current object (for fluent API support)
     */
    public function setIdFisicaDom($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_fisica_dom !== $v) {
            $this->id_fisica_dom = $v;
            $this->modifiedColumns[] = FisicaDomPeer::ID_FISICA_DOM;
        }
    ...
    public function setPfisicaIdPfisica($v)
    {
        ...
        if ($this->pfisica_id_pfisica !== $v) {
            ...
            $this->modifiedColumns[] = FisicaDomPeer::PFISICA_ID_PFISICA;
        }
    ...
    public function setDomicilioIdDomicilio($v)
    {
        ...
        if ($this->domicilio_id_domicilio !== $v) {
            ...
            $this->modifiedColumns[] = FisicaDomPeer::DOMICILIO_ID_DOMICILIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_fisica_dom = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = FisicaDomPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FisicaDom object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FisicaDomPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FisicaDomQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseFisicaDom:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFisicaDom:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseFisicaDom:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseFisicaDom:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                FisicaDomPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FisicaDomPeer::ID_FISICA_DOM;
        if (null !== $this->id_fisica_dom) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . FisicaDomPeer::ID_FISICA_DOM . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(FisicaDomPeer::ID_FISICA_DOM)) {
            $modifiedColumns[':p' . $index++]  = '`ID_FISICA_DOM`';
        }
        if ($this->isColumnModified(FisicaDomPeer::PFISICA_ID_PFISICA)) {
            $modifiedColumns[':p' . $index++]  = '`PFISICA_ID_PFISICA`';
        }
        if ($this->isColumnModified(FisicaDomPeer::DOMICILIO_ID_DOMICILIO)) {
            $modifiedColumns[':p' . $index++]  = '`DOMICILIO_ID_DOMICILIO`';
        }

        $sql = sprintf(
            'INSERT INTO `fisica_dom` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID_FISICA_DOM`':						
						$stmt->bindValue($identifier, $this->id_fisica_dom, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FisicaDomPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FisicaDomPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FisicaDom'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FisicaDom'][$this->getPrimaryKey()] = true;
        $keys = FisicaDomPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdFisicaDom(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdFisicaDom($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FisicaDomPeer::ID_FISICA_DOM)) $criteria->add(FisicaDomPeer::ID_FISICA_DOM, $this->id_fisica_dom);
        if ($this->isColumnModified(FisicaDomPeer::PFISICA_ID_PFISICA)) $criteria->add(FisicaDomPeer::PFISICA_ID_PFISICA, $this->pfisica_id_pfisica);
        if ($this->isColumnModified(FisicaDomPeer::DOMICILIO_ID_DOMICILIO)) $criteria->add(FisicaDomPeer::DOMICILIO_ID_DOMICILIO, $this->domicilio_id_domicilio);
    ...
    {
        $criteria = new Criteria(FisicaDomPeer::DATABASE_NAME);
        $criteria->add(FisicaDomPeer::ID_FISICA_DOM, $this->id_fisica_dom);
    ...
    /**
     * Generic method to set the primary key (id_fisica_dom column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdFisicaDom();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of FisicaDom (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdFisicaDom(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 FisicaDom Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   FisicaDomPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FisicaDomPeer();
        }
    ...
    public function getPfisica(PropelPDO $con = null)
    {
        if ($this->aPfisica === null && ($this->pfisica_id_pfisica !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPfisica->addFisicaDoms($this);
             */
        }
    ...
    public function getDomicilio(PropelPDO $con = null)
    {
        if ($this->aDomicilio === null && ($this->domicilio_id_domicilio !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDomicilio->addFisicaDoms($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FisicaDomPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseFisicaDom:' . $name))
		{
