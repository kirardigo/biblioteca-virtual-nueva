...
abstract class BaseLibroPeer {
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idlibro', 'Nombre', 'Archivo', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idlibro', 'nombre', 'archivo', ),
        BasePeer::TYPE_COLNAME => array (self::IDLIBRO, self::NOMBRE, self::ARCHIVO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDLIBRO', 'NOMBRE', 'ARCHIVO', ),
        BasePeer::TYPE_FIELDNAME => array ('idlibro', 'nombre', 'archivo', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idlibro' => 0, 'Nombre' => 1, 'Archivo' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idlibro' => 0, 'nombre' => 1, 'archivo' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::IDLIBRO => 0, self::NOMBRE => 1, self::ARCHIVO => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDLIBRO' => 0, 'NOMBRE' => 1, 'ARCHIVO' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idlibro' => 0, 'nombre' => 1, 'archivo' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LibroPeer::ARCHIVO);
        } else {
