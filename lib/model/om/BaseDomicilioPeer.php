...
abstract class BaseDomicilioPeer {
     ...
     *
     * @param      Domicilio $obj A Domicilio object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Domicilio) {
                $key = (string) $value->getIdDomicilio();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Domicilio object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = DomicilioPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = DomicilioPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + DomicilioPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = DomicilioPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Domicilio) to the collection in $obj2 (Localidad)
                $obj2->addDomicilio($obj1);
    ...
    {
        return DomicilioPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Domicilio or Criteria object.
     *
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(DomicilioPeer::ID_DOMICILIO) && $criteria->keyContainsValue(DomicilioPeer::ID_DOMICILIO) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Domicilio or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(DomicilioPeer::ID_DOMICILIO);
            $value = $criteria->remove(DomicilioPeer::ID_DOMICILIO);
            if ($value) {
                $selectCriteria->add(DomicilioPeer::ID_DOMICILIO, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(DomicilioPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the domicilio table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(DomicilioPeer::TABLE_NAME, $con, DomicilioPeer::DATABASE_NAME);
    ...
    /**
     * Performs a DELETE on the database, given a Domicilio or Criteria object OR a primary key value.
     *
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(DomicilioPeer::ID_DOMICILIO, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria->add(DomicilioPeer::ID_DOMICILIO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(DomicilioPeer::DATABASE_NAME);
            $criteria->add(DomicilioPeer::ID_DOMICILIO, $pks, Criteria::IN);
