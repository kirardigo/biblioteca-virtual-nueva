...
abstract class BaseSubcontenidoPeer {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += SubcontenidoPeer::doOnDeleteCascade(new Criteria(SubcontenidoPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += SubcontenidoPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = SubcontenidoPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(MaterialPeer::SUBCONTENIDO_ID_SUBCONTENIDO, $obj->getIdSubcontenido());
