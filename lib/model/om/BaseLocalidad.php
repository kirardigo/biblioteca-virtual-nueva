...
abstract class BaseLocalidad extends BaseObject 
{
    ...
    /**
     * The value for the provincia_id_provincia field.
     * @var        int
     */
    protected $provincia_id_provincia;
    ...
    /**
     * Get the [provincia_id_provincia] column value.
     * 
     * @return   int
     */
    ...
    /**
     * Set the value of [provincia_id_provincia] column.
     * 
     * @param      int $v new value
     * @return   Localidad The current object (for fluent API support)
     */
    public function setProvinciaIdProvincia($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->provincia_id_provincia !== $v) {
            $this->provincia_id_provincia = $v;
            $this->modifiedColumns[] = LocalidadPeer::PROVINCIA_ID_PROVINCIA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->provincia_id_provincia = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aProvincia !== null && $this->provincia_id_provincia !== $this->aProvincia->getIdProvincia()) {
            $this->aProvincia = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LocalidadPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE`';
        }
        if ($this->isColumnModified(LocalidadPeer::COD_POSTAL)) {
            $modifiedColumns[':p' . $index++]  = '`COD_POSTAL`';
        }
        if ($this->isColumnModified(LocalidadPeer::PROVINCIA_ID_PROVINCIA)) {
            $modifiedColumns[':p' . $index++]  = '`PROVINCIA_ID_PROVINCIA`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`COD_POSTAL`':						
                        ...
                        break;
                    case '`PROVINCIA_ID_PROVINCIA`':						
						$stmt->bindValue($identifier, $this->provincia_id_provincia, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getProvinciaIdProvincia();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getProvinciaIdProvincia(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setProvinciaIdProvincia($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setProvinciaIdProvincia($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocalidadPeer::PROVINCIA_ID_PROVINCIA)) $criteria->add(LocalidadPeer::PROVINCIA_ID_PROVINCIA, $this->provincia_id_provincia);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProvinciaIdProvincia($this->getProvinciaIdProvincia());
    ...
    {
        if ($v === null) {
            $this->setProvinciaIdProvincia(NULL);
        } else {
            $this->setProvinciaIdProvincia($v->getIdProvincia());
        }
    ...
    {
        if ($this->aProvincia === null && ($this->provincia_id_provincia !== null)) {
            $this->aProvincia = ProvinciaQuery::create()->findPk($this->provincia_id_provincia, $con);
    ...
    public function setDomicilios(PropelCollection $domicilios, PropelPDO $con = null)
    {
        ...
        foreach ($this->domiciliosScheduledForDeletion as $domicilioRemoved) {
            $domicilioRemoved->setLocalidad(null);
        }
    ...
    public function clear()
    {
        ...
        $this->provincia_id_provincia = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
