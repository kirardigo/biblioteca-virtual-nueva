...
abstract class BaseAccesoMaterialPeer {
    ...
    const FISICA_ID_FISICA = 'acceso_material.FISICA_ID_FISICA';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdAccesoMaterial', 'FisicaIdFisica', 'MaterialIdMaterial', 'FechaAcceso', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAccesoMaterial', 'fisicaIdFisica', 'materialIdMaterial', 'fechaAcceso', ),
        BasePeer::TYPE_COLNAME => array (self::ID_ACCESO_MATERIAL, self::FISICA_ID_FISICA, self::MATERIAL_ID_MATERIAL, self::FECHA_ACCESO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACCESO_MATERIAL', 'FISICA_ID_FISICA', 'MATERIAL_ID_MATERIAL', 'FECHA_ACCESO', ),
        BasePeer::TYPE_FIELDNAME => array ('id_acceso_material', 'fisica_id_fisica', 'material_id_material', 'fecha_acceso', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdAccesoMaterial' => 0, 'FisicaIdFisica' => 1, 'MaterialIdMaterial' => 2, 'FechaAcceso' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAccesoMaterial' => 0, 'fisicaIdFisica' => 1, 'materialIdMaterial' => 2, 'fechaAcceso' => 3, ),
        BasePeer::TYPE_COLNAME => array (self::ID_ACCESO_MATERIAL => 0, self::FISICA_ID_FISICA => 1, self::MATERIAL_ID_MATERIAL => 2, self::FECHA_ACCESO => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACCESO_MATERIAL' => 0, 'FISICA_ID_FISICA' => 1, 'MATERIAL_ID_MATERIAL' => 2, 'FECHA_ACCESO' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id_acceso_material' => 0, 'fisica_id_fisica' => 1, 'material_id_material' => 2, 'fecha_acceso' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccesoMaterialPeer::FISICA_ID_FISICA);
    ...
    public static function doCountJoinFisica(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AccesoMaterialPeer::FISICA_ID_FISICA, FisicaPeer::ID_FISICA, $join_behavior);
    ...
    /**
     * Selects a collection of AccesoMaterial objects pre-filled with their Fisica objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinFisica(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (AccesoMaterial) to $obj2 (Fisica)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        MaterialPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + MaterialPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (AccesoMaterial) to the collection in $obj2 (Fisica)
                $obj2->addAccesoMaterial($obj1);
            } // if joined row not null

            // Add objects for joined Material rows

            $key3 = MaterialPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = MaterialPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    MaterialPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (AccesoMaterial) to the collection in $obj3 (Material)
    ...
    /**
     * Selects a collection of AccesoMaterial objects pre-filled with all related objects except Fisica.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
