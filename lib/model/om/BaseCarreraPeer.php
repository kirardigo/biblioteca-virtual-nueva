...
abstract class BaseCarreraPeer {
    ...
    const MATERIAL_ID_MATERIAL = 'carrera.MATERIAL_ID_MATERIAL';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdCarrera', 'Nombre', 'MaterialIdMaterial', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCarrera', 'nombre', 'materialIdMaterial', ),
        BasePeer::TYPE_COLNAME => array (self::ID_CARRERA, self::NOMBRE, self::MATERIAL_ID_MATERIAL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CARRERA', 'NOMBRE', 'MATERIAL_ID_MATERIAL', ),
        BasePeer::TYPE_FIELDNAME => array ('id_carrera', 'nombre', 'material_id_material', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdCarrera' => 0, 'Nombre' => 1, 'MaterialIdMaterial' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCarrera' => 0, 'nombre' => 1, 'materialIdMaterial' => 2, ),
        BasePeer::TYPE_COLNAME => array (self::ID_CARRERA => 0, self::NOMBRE => 1, self::MATERIAL_ID_MATERIAL => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CARRERA' => 0, 'NOMBRE' => 1, 'MATERIAL_ID_MATERIAL' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id_carrera' => 0, 'nombre' => 1, 'material_id_material' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CarreraPeer::MATERIAL_ID_MATERIAL);
        } else {
    ...
    public static function doCountJoinMaterial(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CarreraPeer::MATERIAL_ID_MATERIAL, MaterialPeer::ID_MATERIAL, $join_behavior);
    ...
    /**
     * Selects a collection of Carrera objects pre-filled with their Material objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMaterial(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CarreraPeer::addSelectColumns($criteria);
        $startcol = CarreraPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Carrera) to $obj2 (Material)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CarreraPeer::addSelectColumns($criteria);
        $startcol2 = CarreraPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Carrera) to the collection in $obj2 (Material)
                $obj2->addCarrera($obj1);
