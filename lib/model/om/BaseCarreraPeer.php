...
abstract class BaseCarreraPeer {
    ...
    {
        // Invalidate objects in CarreraFisicaPeer instance pool,
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CarreraPeer::doOnDeleteCascade(new Criteria(CarreraPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CarreraPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CarreraPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CarreraFisica objects
            $criteria = new Criteria(CarreraFisicaPeer::DATABASE_NAME);
            
            $criteria->add(CarreraFisicaPeer::CARRERA_ID_CARRERA, $obj->getIdCarrera());
            $affectedRows += CarreraFisicaPeer::doDelete($criteria, $con);
        }
