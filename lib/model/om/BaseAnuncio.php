...
/**
 * Base class that represents a row from the 'anuncio' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseAnuncio extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'AnuncioPeer';
    ...
    /**
     * The value for the id_anuncio field.
     * @var        int
     */
    ...
    /**
     * The value for the fecha_anuncio field.
    ...
    /**
     * Initializes internal state of BaseAnuncio object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [id_anuncio] column value.
     * 
     * @return   int
     */
    ...
    /**
     * Get the [optionally formatted] temporal [fecha_anuncio] column value.
     * 
     *
     ...
     */
    public function getFechaAnuncio($format = 'Y-m-d H:i:s')
    {
        if ($this->fecha_anuncio === null) {
            return null;
        }


        if ($this->fecha_anuncio === '0000-00-00 00:00:00') {
            // while technically this is not a default value of NULL,
            // this seems to be closest in meaning.
            return null;
        } else {
            try {
                $dt = new DateTime($this->fecha_anuncio);
            } catch (Exception $x) {
                throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->fecha_anuncio, true), $x);
            }
        }
    ...
    /**
     * Set the value of [id_anuncio] column.
     * 
     * @param      int $v new value
     * @return   Anuncio The current object (for fluent API support)
     */
    public function setIdAnuncio($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_anuncio !== $v) {
            $this->id_anuncio = $v;
            $this->modifiedColumns[] = AnuncioPeer::ID_ANUNCIO;
        }
    ...
    public function setInformacion($v)
    {
        ...
        if ($this->informacion !== $v) {
            $this->informacion = $v;
            $this->modifiedColumns[] = AnuncioPeer::INFORMACION;
        }
    ...
    /**
     * Sets the value of [fecha_anuncio] column to a normalized version of the date/time value specified.
     * 
     * @param      mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as NULL.
     * @return   Anuncio The current object (for fluent API support)
     */
    public function setFechaAnuncio($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->fecha_anuncio !== null || $dt !== null) {
            $currentDateAsString = ($this->fecha_anuncio !== null && $tmpDt = new DateTime($this->fecha_anuncio)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->fecha_anuncio = $newDateAsString;
                $this->modifiedColumns[] = AnuncioPeer::FECHA_ANUNCIO;
            }
    ...
    public function setUsuarioIdUsuario($v)
    {
        ...
        if ($this->usuario_id_usuario !== $v) {
            ...
            $this->modifiedColumns[] = AnuncioPeer::USUARIO_ID_USUARIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = AnuncioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Anuncio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AnuncioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AnuncioQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAnuncio:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAnuncio:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAnuncio:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAnuncio:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                AnuncioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AnuncioPeer::FECHA_ANUNCIO)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA_ANUNCIO`';
        }
        if ($this->isColumnModified(AnuncioPeer::USUARIO_ID_USUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`USUARIO_ID_USUARIO`';
        }

        $sql = sprintf(
            'INSERT INTO `anuncio` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`INFORMACION`':						
                        ...
                        break;
                    case '`FECHA_ANUNCIO`':						
						$stmt->bindValue($identifier, $this->fecha_anuncio, PDO::PARAM_STR);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AnuncioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AnuncioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Anuncio'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Anuncio'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(AnuncioPeer::DATABASE_NAME);
        $criteria->add(AnuncioPeer::ID_ANUNCIO, $this->id_anuncio);
    ...
    /**
     * Generic method to set the primary key (id_anuncio column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of Anuncio (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdAnuncio(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Anuncio Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUsuario(PropelPDO $con = null)
    {
        if ($this->aUsuario === null && ($this->usuario_id_usuario !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsuario->addAnuncios($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AnuncioPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseAnuncio:' . $name))
		{
