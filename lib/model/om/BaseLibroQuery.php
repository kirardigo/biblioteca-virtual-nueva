 ...
 * @method     LibroQuery orderByArchivo($order = Criteria::ASC) Order by the archivo column
 *
 * @method     LibroQuery groupByIdlibro() Group by the idlibro column
 * @method     LibroQuery groupByNombre() Group by the nombre column
 * @method     LibroQuery groupByArchivo() Group by the archivo column
 *
 ...
 *
 * @method     Libro findOneByIdlibro(int $idlibro) Return the first Libro filtered by the idlibro column
 * @method     Libro findOneByNombre(string $nombre) Return the first Libro filtered by the nombre column
 * @method     Libro findOneByArchivo(resource $archivo) Return the first Libro filtered by the archivo column
 *
 ...
 * @method     array findByArchivo(resource $archivo) Return Libro objects filtered by the archivo column
 *
...
abstract class BaseLibroQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `IDLIBRO`, `NOMBRE`, `ARCHIVO` FROM `libro` WHERE `IDLIBRO` = :p0';
        try {
    ...
    {
        if (is_array($idlibro) && null === $comparison) {
     ...
     *
     * @param     mixed $archivo The value to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return LibroQuery The current query, for fluid interface
     */
    public function filterByArchivo($archivo = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LibroPeer::ARCHIVO, $archivo, $comparison);
    }
