...
/**
 * Base class that represents a row from the 'juridica_dom' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseJuridicaDom extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'JuridicaDomPeer';
    ...
    /**
     * The value for the id_juridica_dom field.
     * @var        int
     */
    protected $id_juridica_dom;
    ...
    /**
     * Get the [id_juridica_dom] column value.
     * 
     * @return   int
     */
    public function getIdJuridicaDom()
    {

        return $this->id_juridica_dom;
    }
    ...
    /**
     * Set the value of [id_juridica_dom] column.
     * 
     * @param      int $v new value
     * @return   JuridicaDom The current object (for fluent API support)
     */
    public function setIdJuridicaDom($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_juridica_dom !== $v) {
            $this->id_juridica_dom = $v;
            $this->modifiedColumns[] = JuridicaDomPeer::ID_JURIDICA_DOM;
        }
    ...
    public function setPjuridicaIdPjuridica($v)
    {
        ...
        if ($this->pjuridica_id_pjuridica !== $v) {
            ...
            $this->modifiedColumns[] = JuridicaDomPeer::PJURIDICA_ID_PJURIDICA;
        }
    ...
    public function setDomicilioIdDomicilio($v)
    {
        ...
        if ($this->domicilio_id_domicilio !== $v) {
            ...
            $this->modifiedColumns[] = JuridicaDomPeer::DOMICILIO_ID_DOMICILIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_juridica_dom = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->pjuridica_id_pjuridica = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->domicilio_id_domicilio = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = JuridicaDomPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JuridicaDom object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JuridicaDomPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JuridicaDomQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseJuridicaDom:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseJuridicaDom:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseJuridicaDom:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseJuridicaDom:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                JuridicaDomPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JuridicaDomPeer::ID_JURIDICA_DOM)) {
            $modifiedColumns[':p' . $index++]  = '`ID_JURIDICA_DOM`';
        }
        if ($this->isColumnModified(JuridicaDomPeer::PJURIDICA_ID_PJURIDICA)) {
            $modifiedColumns[':p' . $index++]  = '`PJURIDICA_ID_PJURIDICA`';
        }
        if ($this->isColumnModified(JuridicaDomPeer::DOMICILIO_ID_DOMICILIO)) {
            $modifiedColumns[':p' . $index++]  = '`DOMICILIO_ID_DOMICILIO`';
        }

        $sql = sprintf(
            'INSERT INTO `juridica_dom` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID_JURIDICA_DOM`':						
						$stmt->bindValue($identifier, $this->id_juridica_dom, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JuridicaDomPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JuridicaDomPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JuridicaDom'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JuridicaDom'][$this->getPrimaryKey()] = true;
        $keys = JuridicaDomPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdJuridicaDom(),
            $keys[1] => $this->getPjuridicaIdPjuridica(),
            $keys[2] => $this->getDomicilioIdDomicilio(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdJuridicaDom($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setPjuridicaIdPjuridica($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setDomicilioIdDomicilio($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JuridicaDomPeer::ID_JURIDICA_DOM)) $criteria->add(JuridicaDomPeer::ID_JURIDICA_DOM, $this->id_juridica_dom);
        if ($this->isColumnModified(JuridicaDomPeer::PJURIDICA_ID_PJURIDICA)) $criteria->add(JuridicaDomPeer::PJURIDICA_ID_PJURIDICA, $this->pjuridica_id_pjuridica);
        if ($this->isColumnModified(JuridicaDomPeer::DOMICILIO_ID_DOMICILIO)) $criteria->add(JuridicaDomPeer::DOMICILIO_ID_DOMICILIO, $this->domicilio_id_domicilio);
    ...
    {
        $criteria = new Criteria(JuridicaDomPeer::DATABASE_NAME);
        $criteria->add(JuridicaDomPeer::ID_JURIDICA_DOM, $this->id_juridica_dom);
    ...
    /**
     * Generic method to set the primary key (id_juridica_dom column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdJuridicaDom();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of JuridicaDom (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdJuridicaDom(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 JuridicaDom Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   JuridicaDomPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JuridicaDomPeer();
        }
    ...
    public function getPjuridica(PropelPDO $con = null)
    {
        if ($this->aPjuridica === null && ($this->pjuridica_id_pjuridica !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPjuridica->addJuridicaDoms($this);
             */
        }
    ...
    public function getDomicilio(PropelPDO $con = null)
    {
        if ($this->aDomicilio === null && ($this->domicilio_id_domicilio !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDomicilio->addJuridicaDoms($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(JuridicaDomPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseJuridicaDom:' . $name))
		{
