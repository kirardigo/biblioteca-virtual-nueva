...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          &nbsp;<a href="<?php echo url_for('tipodoc/index') ?>">Back to list</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'tipodoc/delete?id_tipo_doc='.$form->getObject()->getIdTipoDoc(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
