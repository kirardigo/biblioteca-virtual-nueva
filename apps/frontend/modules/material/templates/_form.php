...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          &nbsp;<a href="<?php echo url_for('material/index') ?>">Back to list</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'material/delete?id_material='.$form->getObject()->getIdMaterial(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
