  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $Contenido->getNombre() ?></td>
          ...
          <?php echo link_to('<i class="icon-trash icon-white"></i>Eliminar', 'contenido/delete?id_contenido='.$Contenido->getIdContenido(), array('method' => 'delete', 'confirm' => 'Esta seguro de eliminar el contenido?', 'class'=>"btn btn-danger btn-mini")) ?>
      </td>
    </tr>
