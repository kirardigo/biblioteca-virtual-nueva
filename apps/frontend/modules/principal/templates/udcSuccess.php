...
<div id="paging_container3" class="container">
    ...
    <?php if($sf_user->isAuthenticated()):?>
      ...
      if ($ext=='JPG'||$ext=='PNG'||$ext=='BMP'||$ext=='GIF'||$ext=='PDF'||$ext=='GIF'){    
                  echo link_to('<i class="icon-eye-open icon-white"></i>Visualizar', 'lectura/index?archivo='.$Material->getArchivo().'&id='.$Material->getIdMaterial(),array( 'class'=>"btn btn-info btn-mini") );  }
